        ...
        <div className="grid min-h-[520px] grid-cols-1 items-center gap-10 py-14 lg:min-h-[560px] lg:grid-cols-12 lg:py-20">
          <div className="relative z-10 lg:col-span-7">
            <AnimatePresence mode="wait">
              ...
              >
                <span className="inline-flex items-center gap-2 rounded-full border border-safety-500/30 bg-white/90 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-safety-700 shadow-sm">
                  {slide.kicker}
                </span>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  <Link
                    ...
                    className="group inline-flex h-13 items-center gap-2 rounded-xl bg-safety-500 px-7 py-3.5 text-[15px] font-bold text-white shadow-[0_8px_24px_rgba(3,164,53,0.35)] transition-all hover:bg-safety-600 hover:shadow-[0_8px_32px_rgba(3,164,53,0.45)]"
                  >
                    {slide.cta}
                ...
                <div className="mt-8 flex flex-wrap items-center gap-3 text-navy-900/60">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-safety-50 px-3 py-1 text-xs font-bold text-safety-700">
                    ✓ 100% Genuine &amp; Certified
                  </span>
                  <span className="flex items-center gap-2 text-xs font-medium">
                    <BadgePercent className="h-4 w-4 text-safety-600" /> Bulk discounts up to 30%
                  </span>
                  <span className="hidden text-xs sm:inline">✓ 24–72h Nationwide Delivery</span>
                </div>
              </motion.div>
            </AnimatePresence>
          </div>
